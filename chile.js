...
document.addEventListener('DOMContentLoaded', function () {
    var imagensDestaque = document.querySelectorAll('.imagem-destaque');

    imagensDestaque.forEach(function (imagem) {
        // Adiciona um evento de mouseover para aumentar o tamanho da imagem
        imagem.addEventListener('mouseover', function () {
            imagem.style.transform = 'scale(1.15)'; // Aumenta o tamanho em 15%
        });

        // Adiciona um evento de mouseout para retornar ao tamanho original da imagem
